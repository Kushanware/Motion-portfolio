    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="hidden lg:flex flex-row items-center gap-1 text-[15px] font-medium text-white/80 bg-white/5 backdrop-blur-lg border border-white/10 rounded-full px-2 py-1.5 shadow-[0_4px_30px_rgba(0,0,0,0.1)]"
        >
          <a
            href="#projects"
        ...
        {/* Desktop CTA & Socials (right, hidden below lg) */}
        ...
        <button
          ...
          onClick={toggleMenu}
          className="lg:hidden flex flex-col justify-center items-center gap-[5px] w-8 h-8 focus:outline-none z-20 cursor-pointer"
        >
          <span
      ...
      <div
        ...
        className={`fixed inset-0 bg-black/90 backdrop-blur-md z-[19] flex flex-col justify-center px-8 gap-8 transition-opacity duration-300 lg:hidden ${
